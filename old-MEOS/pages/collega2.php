...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="stylesheet" href="/css/collegaDetails2.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <title>MEOS | Admin collega's</title>
</head>
<body>
    <main>
        ...
        <div class="content">
            <div class="all-content">
                <div class="all-cards-wrapper">
                    ...
                    <button type="submit" form="reportForm" value="indienen" class="black-button deleteclass" onclick="showModal('your_id_here')">Persoon aanmaken </button>
            ...
            <div class="straffen-pop-up">
                ...
                <div id="straffen-content-pop-up"></div>
            </div>
        </div>
    </main>
    <script>
...
<script src="/js/dropDownCollegas.js"></script>
<script src="/js/modal-popups/makeStrafPersonPopup.js"></script>
<style>
    .deleteclass {
    display: inline-flex;
align-items: center;
